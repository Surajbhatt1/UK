...
<head>
    <meta charset="UTF-8">
    <title>Stay in Uttarakhand</title>
...
.parallax {
    /* The image used */
    background-image: url("vehicle picture/bg4.jpg");
...
.parallax1 {
    /* The image used */
    background-image: url("vehicle picture/bg.webp");
    height: 100%;
    ...
    <div class="parallax foo">
       <?php include 'navbar.php';?>
        ...
        <div class="hero-text" style="font-size:50px text-align: center; position: absolute;top: 50%;left: 50%;transform: translate(-50%, -50%);color: white;">
            ...
            <h1 class="animated rubberBand">Uttarakhand Stay<br> Hotels And Houses Booking</h1>
            <p>Uttarakhand Stay where you can easily book hotels and houses</p>
            
            <?php if(isset($_SESSION['username'])==true) { ?>
            <a class="btn btn-success" style="text-align: center" href="booking.php">Book a Stay</a>
            
            <?php } else{  ?>
            <a class="btn btn-success" style="text-align: center" href="login.php">Login To Book A Stay</a> 
            <?php } ?> 
       ...
       <br><br>
        <div id="bus_route" class="container">
          <div class="page-header">
            <h1 style="text-align: center">Populer Hotel</h1>      
          </div> 
          <div class="row">
              <div class="col-md-6 foo">
               <!-- <p><b>The ruet bus goes around the rajshahi city in different interval. this is the route of the ruet bus.</b></p> -->
                <img src="vehicle picture/img0.jpg" class="img-responsive"><b>Hotel Name:</b> Grand Mehfil <br><b>Location:</b> Kedarnath, Uttarakhand <br><br>
                <img src="vehicle picture/img01.jpg" class="img-responsive" ><b>Hotel Name:</b>Hotel Uttarakhand <br><b>Location:</b> Badrinath, Uttarakhand  
 
              </div>
              <div class="col-md-6">
                  
                  <!-- <p><b>The ruet bus goes around the rajshahi city in different interval. this is the route of the ruet bus.</b></p> -->
                <img src="vehicle picture/img01.jpg" class="img-responsive" ><b>Hotel Name:</b>Hotel Uttarakhand <br><b>Location:</b> Badrinath, Uttarakhand  <br><br>
                <img src="vehicle picture/img0.jpg" class="img-responsive"><b>Hotel Name:</b> Grand Mehfil <br><b>Location:</b> Kedarnath, Uttarakhand  
        ...
        <div id="bus" class="container">
          <div class="">
            <h1 style="text-align: center">Populer Houses </h1>      
          </div> 
          <div class="row">
              <div class="col-md-6">
                <img src="vehicle picture/img24.jpg" class="img-responsive" ><b>House Name:</b>Radhe Shayam  <br><b>Location:</b>Badrinath, Uttarakhand <br><br>
                <img src="vehicle picture/img13.jpg" class="img-responsive" ><b>House Name:</b>Sadguru Niwas<br><b>Location:</b>kedarnath, Uttarakhand  

              </div>
            
              <div class="col-md-6">
                <img src="vehicle picture/img13.jpg" class="img-responsive" ><b>House Name:</b>Sadguru Niwas<br><b>Location:</b>kedarnath, Uttarakhand  <br><br>
                <img src="vehicle picture/img24.jpg" class="img-responsive" ><b>House Name:</b>Radhe Shayam  <br><b>Location:</b>Badrinath, Uttarakhand
