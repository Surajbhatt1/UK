        ...
        <div class="row">
           <div class="col-md-12">
             <div class="page-header">
                <h1 style="text-align: center;">Request's for Booking List</h1>
              ...
              <table id="myTable" class="table table-bordered animated bounce">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a class="btn btn-default disabled" href="releasebooking.php?id=<?php echo $row['booking_id']; ?>">Release Stay</a></td>
                        <?php } else{ ?>
                        <td><a class="btn btn-default" href="releasebooking.php?id=<?php echo $row['booking_id']; ?>">Release Stay</a></td>
                        <?php } ?>
