            ...
            <div class="col-md-6">
                <form class="animated bounce" action="bookingaction.php" method="post">
                    ...
                    <div class="input-group">
                      ...
                      <label><input type="radio" name="type" value="bus">Mini Bus</label>
                    </div>
                    <br>
                    <div class="input-group">
                      <span class="input-group-addon"><b>How many people?</b></span> &nbsp;
                      <label><input type="number" name="type" ></label> &nbsp;
                    </div>
                    <br>
                    <div class="input-group">
                    ...
                    <div class="input-group">
                      ...
                      <input id="mobile" type="number"  class="form-control" name="mobile" placeholder="Mobile No" maxlength="10" required >
                    </div>
                    <br>
