...
<body>
            ...
            <div class="menu-par">
                ...
                <div class="nav">
                    <ul style="font-size:22px;">
                        ...
                        <li><a class="menu_hover" href="#">Explore</a></li>
                        <li><a class="menu_hover" href="#">Where To Stay</a></li>
                        <li><a class="menu_hover" href="#">Gallery</a></li>
                        <li><a class="menu_hover" href="login.html"><i class="fa-regular fa-user"></i></a></li>
                    </ul>
                </div>
    ...
    <header>
        ...
        <div class="video">
            ...
            <source type="video/mp4" src="images/travel-video.mp4" />
            </video>
        </div>
    </header>
    ...
    <Section id="welcome_Sec">
        <div class="container">
            <h2><span>The official travel site of the friendly Fiji Islands</span></h2>
        ...
        <div class="container">
            <div class="row">
                <div align="center">
                    ...
                    <button class="btn filter-button" data-filter="hdpe">Adventure</button>
                    <button class="btn filter-button" data-filter="sprinkle">Nature</button>
                    <button class="btn filter-button" data-filter="spray">Spiritual</button>
                    <button class="btn filter-button" data-filter="spray">Pilgrimage</button>
                    <button class="btn filter-button" data-filter="spray">Food</button>
                    <button class="btn filter-button" data-filter="spray">Wildlife</button>
                    <button class="btn filter-button" data-filter="spray">Destination</button>
                    <button class="btn filter-button" data-filter="spray">Festival</button>
